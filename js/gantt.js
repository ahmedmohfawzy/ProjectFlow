 ...
 */
    const DARK_COLORS = {
        ...
        barLabel: 'rgba(255,255,255,0.9)', hoverRow: 'rgba(255,255,255,0.03)',
    };
    const LIGHT_COLORS = {
        bg: '#fafbfd', gridLine: 'rgba(0,0,0,0.06)', gridLineMajor: 'rgba(0,0,0,0.12)',
        weekend: 'rgba(0,0,0,0.025)', today: 'rgba(239,68,68,0.08)', todayLine: '#ef4444',
        bar: '#6366f1', barHover: '#818cf8', barBorder: '#4f46e5',
        progress: '#22c55e', progressBg: 'rgba(34,197,94,0.25)',
        summary: '#8b5cf6', summaryBorder: '#7c3aed',
        milestone: '#f59e0b', milestoneBorder: '#d97706',
        critical: '#ef4444', criticalBorder: '#dc2626',
        baseline: 'rgba(148,163,184,0.35)', baselineBorder: 'rgba(148,163,184,0.5)',
        link: 'rgba(100,116,139,0.4)', linkArrow: 'rgba(100,116,139,0.6)',
        text: '#4a5068', textBright: '#1a1d2e', textMuted: '#8892a8',
        selectedRow: 'rgba(99,102,241,0.08)', dragPreview: 'rgba(99,102,241,0.2)',
        barLabel: 'rgba(255,255,255,0.95)', hoverRow: 'rgba(0,0,0,0.02)',
    };
    function _getColors() {
